<?php
    ...
    $TEXT['lang-code'] = "ua";
    $TEXT['lang-name'] = "Українська";


    $TEXT['mode-demo'] = "Режим демоверсії. Зміни не будуть збережені.";

    $TEXT['topbar-users'] = "Користувачі";

    $TEXT['topbar-stats'] = "Статистика";

    $TEXT['topbar-signin'] = "Увійти";

    $TEXT['topbar-friends'] = "Друзі";

    $TEXT['topbar-logout'] = "Вийти";

    $TEXT['topbar-signup'] = "Реєстрація";

    $TEXT['topbar-settings'] = "Налаштування";

    $TEXT['topbar-support'] = "Підтримка";

    $TEXT['topbar-profile'] = "Профіль";

    $TEXT['topbar-likes'] = "Сповіщення";

    $TEXT['topbar-search'] = "Пошук";

    $TEXT['topbar-main-page'] = "Головна";

    $TEXT['topbar-wall'] = "Головна";

    $TEXT['topbar-messages'] = "Повідомлення";

    $TEXT['footer-about'] = "про сайт";

    $TEXT['footer-terms'] = "правила";

    $TEXT['footer-contact'] = "контакти";

    $TEXT['footer-support'] = "підтримка";

    $TEXT['page-main'] = "Головна";

    $TEXT['page-users'] = "Користувачі";

    $TEXT['page-hashtags'] = "Хештеги";

    $TEXT['page-terms'] = "Правила";

    $TEXT['page-about'] = "Про сайт";

    $TEXT['page-language'] = "Оберіть мову";

    $TEXT['page-support'] = "Підтримка";

    $TEXT['page-restore'] = "Відновлення паролю";

    $TEXT['page-restore-sub-title'] = "Введіть email, на який зареєстрована сторінка.";

    $TEXT['page-signup'] = "реєстрація";

    $TEXT['page-login'] = "Увійти";

    $TEXT['page-wall'] = "Новини";

    $TEXT['page-blacklist'] = "Чорний список";

    $TEXT['page-messages'] = "Повідомлення";

    $TEXT['page-stream'] = "Стрічка";

    $TEXT['page-following'] = "Читають";

    $TEXT['page-friends'] = "Друзі";

    $TEXT['page-followers'] = "Підписувачі";



    $TEXT['page-search'] = "Пошук";

    $TEXT['page-profile-report'] = "Скарга";

    $TEXT['page-profile-block'] = "Блокувати";

    $TEXT['page-profile-upload-avatar'] = "Змінити фото";

    $TEXT['page-profile-upload-cover'] = "Змінити обкладинку";

    $TEXT['page-profile-report-sub-title'] = "Профілі, на які є скарги, перевіряються модератором та можуть бути блоковані, якщо вони порушують наші правила.";

    $TEXT['page-profile-block-sub-title'] = "не зможе писати коментарі до ваших постів і надсилати Вам особисті повідомлення, і ви не будете отримувати повідомлення від";



    $TEXT['page-likes'] = "Люди, яким це подобається";

    $TEXT['page-services'] = "Сервіси";

    $TEXT['page-services-sub-title'] = "З\'єднайте Dating App з обліковим записом у соціальній мережі";

    $TEXT['page-prompt'] = "реєстрація або вхід";

    $TEXT['page-settings'] = "Налаштування";

    $TEXT['page-profile-settings'] = "Профіль";

    $TEXT['page-profile-password'] = "Змінити пароль";

    $TEXT['page-notifications-likes'] = "Сповіщення";

    $TEXT['page-profile-deactivation'] = "Деактивувати профіль";

    $TEXT['page-profile-deactivation-sub-title'] = "Залишаєте нас?<br>Пам\'ятайте, що Ви завжди можете повернутися назад, ввівши свій логін і пароль на сторінці входу. Ми нудьгуватимемо без Вас!";

    $TEXT['page-error-404'] = "Сторінку не знайдено";

    $TEXT['label-location'] = "Місцезнаходження";
    $TEXT['label-facebook-link'] = "Сторінка Facebook";
    $TEXT['label-instagram-link'] = "Сторінка Instagram";
    $TEXT['label-status'] = "Про себе";

    $TEXT['label-error-404'] = "Запрошувану сторінку не знайдено.";

    $TEXT['label-account-disabled'] = "Користувач відключив свій обліковий запис.";

    $TEXT['label-account-blocked'] = "Обліковий запис заблоковано адміністратором.";

    $TEXT['label-account-deactivated'] = "Обліковий запис не активовано.";

    $TEXT['label-reposition-cover'] = "Обкладинку можна рухати";

    $TEXT['label-or'] = "або";

    $TEXT['label-and'] = "та";

    $TEXT['label-signup-confirm'] = "При натисканні Реєстрація, Ви погоджуєтесь з нашими";



    $TEXT['label-empty-page'] = "Тут пусто.";

    $TEXT['label-empty-questions'] = "Це посилання на профіль. Поділися її зі своїми друзями.";

    $TEXT['label-empty-list'] = "Список порожній.";

    $TEXT['label-empty-feeds'] = "Тут Ви будете бачити записи Ваших друзів.";

    $TEXT['label-search-result'] = "Результати пошуку";

    $TEXT['label-search-empty'] = "Нічого не знайдено.";

    $TEXT['label-search-prompt'] = "Шукати користувачів за логіном.";

    $TEXT['label-who-us'] = "Дивіться хто з нами";
    ...
    $TEXT['label-messages-privacy'] = "Налаштування повідомлень";

    $TEXT['label-messages-allow'] = "Принимать сообщения от всех пользователей.";

    $TEXT['label-messages-allow-desc'] = "Вы будете иметь возможность получать сообщения от любого пользователя, даже если пользователь не в списке ваших друзей.";
    ...
    $TEXT['label-you-like'] = "Which gender do you like?";
    ...
    $TEXT['label-smoking-views-2'] = "Negative";
    $TEXT['label-smoking-views-3'] = "Compromisable";
    $TEXT['label-smoking-views-4'] = "Neutral";
    $TEXT['label-smoking-views-5'] = "Positive";

    $TEXT['label-alcohol-views-0'] = "None selected";
    $TEXT['label-alcohol-views-1'] = "Very negative";
    $TEXT['label-alcohol-views-2'] = "Negative";
    $TEXT['label-alcohol-views-3'] = "Compromisable";
    $TEXT['label-alcohol-views-4'] = "Neutral";
    $TEXT['label-alcohol-views-5'] = "Positive";

    $TEXT['label-you-looking-0'] = "None selected";
    $TEXT['label-you-looking-1'] = "Friendship";
    $TEXT['label-you-looking-2'] = "Relationship";
    $TEXT['label-you-looking-3'] = "Flirting";

    $TEXT['label-you-like-0'] = "None selected";
    $TEXT['label-you-like-1'] = "I'm interested in women";
    $TEXT['label-you-like-2'] = "I'm interested in men";

    $TEXT['label-profile-you-like-1'] = "I'm interested in women";
    $TEXT['label-profile-you-like-2'] = "I'm interested in men";

    $TEXT['label-notify-profile-like'] = "оставил лайк.";
    $TEXT['label-notify-gift'] = "сделал подарок.";

    $TEXT['page-guests'] = "Гости";
    $TEXT['topbar-guests'] = "Гости";

    // for version 1.8
    //
    //

    $TEXT['page-profile-likes'] = "Нравится";
    $TEXT['topbar-profile-likes'] = "Нравится";

    $TEXT['page-i-liked'] = "Мне Нравится";
    $TEXT['topbar-i-liked'] = "Мне Нравится";

    // For version 3.0

    $TEXT['page-referrals'] = "Рефералы";
    $TEXT['label-referrals-list'] = "Список Рефералов";
    ...
    $TEXT['label-pro-mode-alert'] = "Для отправки сообщений вам нужно активировать \"Pro Mode\" или купить \"Пакет сообщений\" в секции \"Модернизация\"";

    // For version 3.2

    $TEXT['page-profile-deactivation-sub-title2'] = "Помните!<br>Вы не сможете восстановить этот аккаунт и Ваши фотографии будут удалены!";
    ...
    $TEXT['label-sex-orientation'] = "Сексуальная ориентация";
    $TEXT['label-age'] = "Возраст";
    $TEXT['label-sex'] = "Пол";
    $TEXT['label-height'] = "Высота";
    $TEXT['label-weight'] = "Вес";
    $TEXT['label-cm'] = "см"; //centimeters
    $TEXT['label-kg'] = "кг"; //kilograms

    $TEXT['label-select-gender'] = "Пол";
    $TEXT['label-select-sex-orientation'] = "Сексуальная ориентация";
    $TEXT['label-select-age'] = "Возраст";

    $TEXT['msg-gender-incorrect'] = "Пожалуйста, укажите ваш пол";
    $TEXT['msg-sex-orientation-incorrect'] = "Пожалуйста, выберите вашу сексуальную ориентацию";
    $TEXT['msg-age-incorrect'] = "Пожалуйста, выберите ваш возраст";

    $TEXT['sex-orientation-1'] = "Гетеросексуал";
    $TEXT['sex-orientation-2'] = "Гей";
    $TEXT['sex-orientation-3'] = "Лесбиянка";
    $TEXT['sex-orientation-4'] = "Бисексуал";
    ...
    $TEXT['tab-likes'] = "Нравится";
    $TEXT['tab-liked'] = "Мне Нравится";

    $TEXT['page-likes'] = "Нравится";
    $TEXT['page-liked'] = "Мне Нравится";

    $TEXT['topbar-likes'] = "Нравится";
    $TEXT['topbar-notifications'] = "Уведомления";

    $TEXT['page-search-description'] = "Search people by name, surname, login, email or location";
    $TEXT['search-box-placeholder'] = "Enter user name, surname, login, email or location";
    ...
    $TEXT['label-last-visit'] = "Последний визит";
    $TEXT['label-last-seen'] = "Последний раз онлайн";
    $TEXT['label-new-gift'] = "сделал подарок.";

    $TEXT['main-page-prompt-app'] = "Dating App идет, куда вы идете, так что вы можете искать людей и общаться с друзьями в любое время, в любом месте. Оставайтесь на связи с друзьями с мобильного приложения Dating App. Доступно для Android.";

    // For version 4.2

    $TEXT['label-notify-media-approve'] = "одобрил вашу публикацию.";
    $TEXT['label-notify-media-reject'] = "отклонил вашу публикацию.";

    $TEXT['label-notify-profile-photo-approve'] = "одобрил ваше фото профиля.";
    $TEXT['label-notify-profile-photo-reject'] = "отклонил вашу фотографию профиля.";

    // For version 4.3

    $TEXT['gender-secret'] = "Секрет";

    $TEXT['label-notify-profile-photo-approve-subtitle'] = "Ваш профиль успешно прошел модерацию! Вы можете использовать все функции приложения!";
    $TEXT['label-notify-profile-photo-reject-subtitle'] = "Загрузите/измените фото профиля для повторного прохождения модерации.";

    $TEXT['dlg-moderation-title'] = "Модерация";
    $TEXT['dlg-moderation-subtitle'] = "Доступно только для успешно прошедших модерацию аккаунтов!";
    $TEXT['msg-account-not-moderated'] = "Ваш профиль еще не прошел модерацию!";

    // For version 4.5

    $TEXT['label-notify-profile-cover-approve'] = "одобрил вашу обложку  профиля.";
    $TEXT['label-notify-profile-cover-reject'] = "отклонил вашу обложку профиля.";

    $TEXT['label-notify-profile-cover-approve-subtitle'] = "Ваша обложка профиля успешно прошла модерацию!";
    $TEXT['label-notify-profile-cover-reject-subtitle'] = "Загрузите/измените обложку профиля для повторного прохождения модерации.";

    $TEXT['label-profile-photo-moderation-active'] = "Фото профиля будет доступно для пользователей после модерации. Сейчас пользователи видят Ваше предыдущее фото, одобренное модераторами или фото по умолчанию.";
    $TEXT['label-profile-cover-moderation-active'] = "Обложка профиля будет доступна для всех пользователей после модерации. Сейчас пользователи видят Вашу предыдущую обложку, одобренную модераторами или обложку по умолчанию.";
    ...
    $TEXT['main-page-prompt-login'] = "Знакомьтесь и Общайтесь с людьми! Дарите людям подарки и лайки! Вы найдете свою пару, свою любовь, друзей и приятно проведете время за общением с людьми!";
    $TEXT['main-page-sub-prompt-login'] = "Войдите в свой аккаунт для продолжения.";
    $TEXT['main-page-prompt-signup'] = "Присоединяйтесь к %s, где вы сможете познакомится с новыми людьми для общения и встреч!";
    ...
    $TEXT['label-liked-sub-title'] = "Люди, которым я нравлюсь";
    $TEXT['label-likes-sub-title'] = "Люди, которые нравятся мне";

    $TEXT['label-welcome-title'] = "Приветствуем!";
    $TEXT['label-welcome-sub-title'] = "Загрузите фотографию для Вашего Профиля, а также введите другие данные о себе. Настоящие фото и достоверная инфомация поможет вам быстрее найти людей для знакомств и дружбы!";

    $TEXT['page-gallery'] = "Галерея";
    $TEXT['page-my-gallery'] = "Моя галерея";
    $TEXT['page-matches'] = "Совпадения";
    $TEXT['page-media-stream'] = "Поток фотографий";
    $TEXT['page-media-feed'] = "Обновления друзей";

    $TEXT['page-gallery-sub-title'] = "Фотографии и видео";
    $TEXT['page-matches-sub-title'] = "Мои совпадения";
    $TEXT['page-media-stream-sub-title'] = "Глобальный поток фотографий пользователей";
    $TEXT['page-media-feed-sub-title'] = "Фотографии моих друзей";

    $TEXT['action-add-photo'] = "Добавить фото";
    $TEXT['label-add-photo'] = "Выберите фотографию, чтобы добавить ее в галерею";

    $TEXT['label-wait-moderation'] = "Ожидает модерации";

    $TEXT['label-gallery-allow'] = "Показывать мою галерею только для друзей";
    $TEXT['label-gallery-privacy'] = "Настройки конфиденциальности для галереи";

    $TEXT['label-error-permission'] = "Информация доступна только друзьям пользователя.";

    // For version 4.8

    $TEXT['page-gifts'] = "Подарки";
    $TEXT['page-gifts-sub-title'] = "Здесь вы можете видеть подарки от пользователей";

    $TEXT['page-upgrades'] = "Модернизация";
    $TEXT['page-upgrades-sub-title'] = "Получите больше активацией дополнительных возможностей!";

    $TEXT['label-gifts'] = "Подарки";
    $TEXT['label-gift'] = "Подарок";
    $TEXT['label-select-gift'] = "Выберите подарок";

    $TEXT['label-gifts-allow'] = "Показывать мои подарки только для друзей";
    $TEXT['label-gifts-privacy'] = "Настройки конфиденциальности для подарков";

    $TEXT['label-info-allow'] = "Показывать информацию в профиле только для друзей";
    $TEXT['label-info-privacy'] = "Настройки конфиденциальности для профиля";
    $TEXT['label-info-error-permission'] = "Информация доступна только друзьям пользователя.";

    $TEXT['label-credits'] = "Кредиты";
    $TEXT['label-credits-desc'] = "Кредиты - универсальная валюта. Кредитами вы можете оплачивать подарки и активировать другие функции.";
    ...
    $TEXT['label-payments-pro-mode'] = "Активация Pro Mode";
    $TEXT['label-payments-message-package'] = "Активация Message Package";
    $TEXT['label-payments-spotlight-feature'] = "Использование функции Spotlight";
    ...
    $TEXT['label-upgrades-pro-mode-desc'] = "Безлимитные сообщения и красивый значок!";
    $TEXT['label-upgrades-message-package'] = "Пакет сообщений (100 сообщений)";
    $TEXT['label-upgrades-message-package-desc'] = "Купите пакет сообщений, чтобы отправлять пользователям приватные сообщения. Также вы можете активировать Pro Mode, чтобы отправлять безграничное количество сообщений.";

    $TEXT['label-free-messages-count'] = "У Вас %s сообщений, которые вы можете отправить.";
    ...
    $TEXT['page-spotlight'] = "В центре внимания";
    $TEXT['page-spotlight-desc'] = "Получай больше лайков, подарков и новых знакомых и друзей!";

    $TEXT['action-add-me'] = "Добавить меня сюда";

    $TEXT['msg-spotlight-dlg-content'] = "Ваш профиль будет добавлен в начало списка и будите находится на первой позиции пока другой пользователь не добавит свой профиль в этот список. За использование функции с вашего внутреннего баланса будет списано %s кредитов. Вы согласны?";

    // For version 4.9

    $TEXT['search-filters-secret'] = "Секрет";
    $TEXT['search-filters-any'] = "Любой";
    $TEXT['search-filters-age'] = "Возвраст от %s до %s";
    $TEXT['search-filters-pro-mode'] = "Pro mode";
    $TEXT['search-filters-pro-mode-on'] = "Только с Pro Mode";
    $TEXT['search-filters-addition'] = "Разное";
    $TEXT['search-filters-matches'] = "Совпадения";
    $TEXT['search-filters-liked'] = "Нравится";

    $TEXT['page-hotgame'] = "Горячо или Холодно";
    $TEXT['page-hotgame-desc'] = "Нравится или нет. Найдите совпадения.";
    ...
    $TEXT['label-hotgame-empty-list'] = "Не найдено людей. Попробуйте изменить параметры, например: увеличьте дистанцию.";

    $TEXT['label-select-feeling'] = "Выберите чувство";
    ...
    $TEXT['label-likes-list-allow'] = "Показывать кому нравится мой профиль только друзьям";
    $TEXT['label-likes-list-privacy'] = "Приватность для лайков";

    $TEXT['label-friends-list-allow'] = "Показывать мой список друзей только друзьям";
    $TEXT['label-friends-list-privacy'] = "Приватность для списка друзей";

    $TEXT['page-privacy-settings'] = "Приватность";
    $TEXT['page-privacy-settings-desc'] = "Настройки приватности для профиля.";

    $TEXT['page-deactivate-account'] = "Деактивировать";
    $TEXT['page-blacklist'] = "Черный список";

    $TEXT['label-friends-sub-title-2'] = "Здесь вы можете увидеть список друзей %s";
    $TEXT['label-likes-sub-title-2'] = "Люди, которым нравится %s";

    $TEXT['label-prompt-app'] = "%s идет туда, куда вы идете, поэтому вы можете искать людей и общаться с друзьями в любое время и в любом месте. Оставайтесь на связи с друзьями с помощью мобильного приложения %s";
    ...
    $TEXT['label-item-missing'] = "Элемент не существует или был удален.";

    $TEXT['label-likes'] = "Мне нравится";
    $TEXT['label-comments'] = "Комментарии";

    $TEXT['label-notify-gallery-item-like'] = "понравилась публикация в Вашей галерее.";

    $TEXT['action-add-photo'] = "Фото";
    $TEXT['action-add-video'] = "Видео";

    $TEXT['label-show-on-stream'] = "Показывать в потоке";
    $TEXT['label-not-show-on-stream'] = "Не показывать в потоке";

    $TEXT['placeholder-gallery-item-description'] = "Добавьте описание здесь...";

    $TEXT['label-post-form-title'] = "Добавить новое фото или видео";
    $TEXT['label-post-form-subtitle'] = "Все фото и видео, которые Вы публикуете, проходят обязательную модерацию перд тем как будут доступны другим пользователям";

    $TEXT['label-item-moderation-wait'] = "Будет доступно для других пользователей после одобрения модератором";
    $TEXT['label-item-moderation-success'] = "Одобрено модератором и доступно другим пользователям";

    // For version 5.2

    $TEXT['page-otp'] = "OTP Верификация";
    $TEXT['page-otp-desc'] = "Верификация номера телефона.";

    $TEXT['action-send-code'] = "Выслать код";
    $TEXT['action-check-code'] = "Проверить код";

    $TEXT['label-otp-phone-format-error'] = "Неверный формат номера телефона.";
    $TEXT['label-otp-phone-number-taken-error'] = "Этот номер телефона уже привязан к другому аккаунту.";
    $TEXT['label-otp-many-requests-error'] = "Мы заблокировали все запросы с этого устройства из-за необычной активности. Попробуйте позже.";
    $TEXT['label-otp-captcha-error'] = "Обновите страницу и попробуйте еще раз.";

    $TEXT['label-otp-verification-code-error'] = "Введен неверный код из СМС";
    $TEXT['label-otp-verification-code-sent'] = "На Ваш мобильный отправлено СМС с кодом";
    $TEXT['label-otp-verification-error'] = "Ошибка. Верификация не завершена";
    $TEXT['label-otp-verification-success'] = "Ура. Верификация успешно завершена!";

    $TEXT['label-otp-phone-number-msg'] = "Номер мобильного телефона в международном формате, например: +380974556781";
    $TEXT['label-otp-code-msg'] = "Шестизначный цифровой код из СМС";

    $TEXT['placeholder-otp-phone-number'] = "Введите номер мобильного телефона...";
    $TEXT['placeholder-otp-code'] = "Введите код из СМС...";

    $TEXT['label-otp-verification-promo'] = "Эта возможность доступна только для пользователей, которые привязали и подтвердили мобильный номер телефона. Привяжите свой номер телефона к аккаунту и подтвердите с помощью СМС, чтобы использовать все функции без ограничений!";

    // For version 5.4

    $TEXT['label-find-empty'] = "По Вашему поисковому запросу ничего не найдено. Попробуйте изменить поисковые фильтры и увеличить дистанцию поиска.";

    // For version 6.0

    $TEXT['label-google'] = "Google";
    $TEXT['label-authorization-with-google'] = "Authorization via Google.";
    $TEXT['label-connected-with-google'] = "Connected with Google";
    $TEXT['label-services-google-connected'] = "You have successfully linked My Social Network with your account on Google!";
    $TEXT['label-services-google-disconnected'] = "Connect with your Google account removed.";
    $TEXT['label-services-google-error'] = "Your Google account is already associated with another account.";
    $TEXT['action-connect-google'] = "Connect with Google";

    // For version 6.2

    $TEXT['label-month-time'] = "На 30 днів";
    $TEXT['label-life-time'] = "Назавжди";

    // For version 6.3

    $TEXT['label-theme'] = "Тема";
    $TEXT['label-day-night-theme'] = "День/Ночь";

    $TEXT['label-choice-place-promo'] = "Если вы не хотите давать доступ к своей геолокации, тогда вы можете выбрать один из городов их списка нижа. Выбирите наиболее подходящий для вас город:";
    $TEXT['label-choice-place'] = "Выбирите город";

    // For version 6.7

    $TEXT['label-video-calls-privacy'] = "Налаштування конфіденційності для відеодзвінків";
    $TEXT['label-video-calls-allow'] = "Я дозволяю відеодзвінки";