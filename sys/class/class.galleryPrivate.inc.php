...
class galleryPrivate extends db_connect
{
    ...
    {
        $stmt = $this->db->prepare("SELECT count(*) FROM private_photos");
        $stmt->execute();
    ...
    {
        $stmt = $this->db->prepare("SELECT MAX(id) FROM private_photos");
        $stmt->execute();
    ...
    {
        $sql = "SELECT count(*) FROM private_photos WHERE removeAt = 0";
    ...
    public function removeAll() {
        ...
        $stmt = $this->db->prepare("UPDATE private_photos SET removeAt = (:removeAt) WHERE fromUserId = (:fromUserId) AND removeAt = 0");
        $stmt->bindParam(":fromUserId", $this->requestFrom, PDO::PARAM_INT);
    ...
    public function remove($photoId)
    {
        ...
        $stmt = $this->db->prepare("UPDATE private_photos SET removeAt = (:removeAt) WHERE id = (:photoId)");
    ...
    public function approve($itemId)
    {
        ...
        $stmt = $this->db->prepare("UPDATE private_photos SET moderateAt = (:moderateAt) WHERE id = (:itemId)");
    ...
    public function restore($photoId)
    {
        ...
        $stmt = $this->db->prepare("UPDATE private_photos SET removeAt = 0 WHERE id = (:photoId)");
        $stmt->bindParam(":photoId", $photoId, PDO::PARAM_INT);
    ...
    public function recalculate($itemId)
    {
        ...
        $stmt = $this->db->prepare("UPDATE private_photos SET likesCount = (:likesCount), commentsCount = (:commentsCount), rating = (:rating) WHERE id = (:itemId)");
    ...
    public function info($itemId)
    {
        ...
        $stmt = $this->db->prepare("SELECT * FROM private_photos WHERE id = (:itemId) LIMIT 1");
        $stmt->bindParam(":itemId", $itemId, PDO::PARAM_INT);
    ...
    public function get($itemId = 0, $profileId = 0, $stream = false, $access = false, $moderate = -1, $limit = 20)
    {
        ...
        $sql = "SELECT * FROM private_photos WHERE removeAt = 0 AND id < {$itemId}".$profileSql.$accessSql.$streamSql.$moderateSql.$endSql;
        $stmt = $this->db->prepare($sql);
