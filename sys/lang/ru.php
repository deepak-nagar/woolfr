<?php
    ...
    $TEXT['label-liked-sub-title'] = "Люди, которые нравятся мне";
    $TEXT['label-likes-sub-title'] = "Люди, которым я нравлюсь";
    ...
    $TEXT['label-authorization-with-google'] = "Авторизация через Google.";
    $TEXT['label-connected-with-google'] = "Подключить к Google";
    $TEXT['label-services-google-connected'] = "Вы успешно связали свой аккаунт с Google!";
    $TEXT['label-services-google-disconnected'] = "Вы удалили связь с аккаунтом Google.";
    $TEXT['label-services-google-error'] = "Ваш аккаунт Google уже связан с другим аккаунтом.";
    $TEXT['action-connect-google'] = "Подключиться к Google";

    // For version 6.2

    $TEXT['label-month-time'] = "На 30 дней";
    $TEXT['label-life-time'] = "Навсегда";
    ...
    $TEXT['label-choice-geo-promo'] = "Если вы не хотите давать разрешение на доступ к своей геолокации, то мы можем попытаться установить ваше приблизительное местоположение (оно может сильно отличаться от вашего реального местоположения):";
    $TEXT['action-set-location'] = "Установить местоположение";

    // For version 6.4

    $TEXT['label-spam-check'] = "Подозрительное сообщение от непроверенного пользователя. Это спам?";
    $TEXT['label-spam-check-thanks'] = "Спасибо! Ваше мнение важно для нас! Вы хотите удалить этот чат?";
    $TEXT['action-spam'] = "Спам";
    $TEXT['action-not-spam'] = "Не спам";

    // For version 6.7

    $TEXT['label-video-calls-privacy'] = "Настройки конфиденциальности для видеозвонков";
    $TEXT['label-video-calls-allow'] = "Разрешаю видеозвонки";